...
function clickElement(element, init, {
  ...
  if (!element.disabled) {
    ...
    if (continueDefaultHandling) {
      if (previousElement) (0, _blur.blur)(previousElement, init);
      if (shouldFocus) (0, _focus.focus)(element, init);
    }
  }
  ...
  if (!element.disabled) {
    ...
    if (parentLabel == null ? void 0 : parentLabel.control) (0, _focus.focus)(parentLabel.control, init);
  }
}
