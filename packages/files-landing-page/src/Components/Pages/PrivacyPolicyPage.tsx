    ...
    <div className={classes.container}>
      ...
      <ul className={clsx(classes.unorderedList, classes.padLarge)}>
        <li>
          ...
          our customers and website users ("you").
        </li>
        <li>
      ...
      >
        <Trans>
          This Policy describes the information we may collect, the purposes for
          which we collect it, how we use it and how we keep it secure.
          ChainSafe will not collect, use or disclose your personal information
          in any way other than in compliance with this policy unless obligated
          by applicable law.
        </Trans>
      </Typography>
      ...
      >
        <Trans>
          ...
          compromising privacy concerns. Any content uploaded to ChainSafe Files
          is encrypted both in transit and when stored on Filecoin storage
          mining nodes. Most importantly, uploaded content is owned by the
          uploader; we do not sell uploaded content to third-parties. Users may
          upload files pseudonymously by registering an account using an
          Ethereum address.
        </Trans>
      </Typography>
      {/* How you agree */}
      ...
      >
        <Trans>
          ...
          name, billing address, e-mail address, Internet protocol (IP) address,
          user name or other similar identifier, and any other identifier we may
          use to bill you or contact you (<b>"personal information"</b>). This
          will most likely be the case when you opt to pay for our Service using
          a credit card.
        </Trans>
      </Typography>
      <Typography
      ...
      >
        <Trans>
          <b>Personal information for account registration:</b> In the case that
          you register for an account using our OAuth service, your name, email
          and username from the OAuth service may be collected and stored to
          identify your Files account. In the case that you register using an
          Ethereum address, we store your Ethereum address to associate it with
          your account. We will store your email address only if you opt-in to
          providing it. It is not required by users logging in with an Ethereum
          address to provide an email.
        </Trans>
      </Typography>
      <Typography
        component="p"
      ...
      >
        <Trans>
          <b>Personal information for purchasing subscriptions:</b> In the case
          that you purchase a subscription to our service with a credit card, we
          may store your billing information. ChainSafe Files uses a third-party
          payment processor, and it is necessary for us to share your payment
          information with the processor to know which account the payment
          applies to. We do not store your payment information for any other
          purpose. In the case that you purchase a subscription to our service
          with cryptocurrency, we may collect transaction information.
        </Trans>
      </Typography>
      <Typography
        component="p"
      ...
      >
        <Trans>
          ...
          services or opt-out of contact from us on an ongoing basis. Users may
          unsubscribe at any time on the Website.
        </Trans>
      </Typography>
      <Typography
        component="p"
      ...
      >
        <Trans>
          <b>Non-personal information:</b> Info that does not in any way reveal
          ...
          Statistical or aggregated data does not directly identify a person,
          but we may derive non-personal statistical or aggregated data from
          personal information. For example, we may aggregate personal
          information to calculate the percentage of users accessing a specific
          Website feature, such as a video. Files may also be able to access
          information about account activity that is unencrypted. This would
          include information such as payment type, language preference, storage
          space used and files size after encryption. This information is used
          solely to provide a smooth user experience and will not be shared or
          sold.
        </Trans>
      </Typography>
      <Typography
      ...
      >
        <Trans>
          ...
          usage details. This might also include IDs of errors, communications
          with the support team or bug reports to improve our service.
        </Trans>
      </Typography>
      <Typography
        component="p"
      ...
      >
        <Trans>
          ...
          scrolling, clicks, and mouse-overs), methods used to browse away from
          the page, or any phone number used to call our customer service
          number.
        </Trans>
      </Typography>
      ...
      >
        <Trans>
          In most cases, we collect information about you when you give it to us
          directly. For example, when you create an account or register
          for/purchase our services. Also, like many websites and technologies,
          we automatically collect technical data when you visit and interact
          with the Website and ChainSafe Files.
        </Trans>
      </Typography>
      <Typography
        component="p"
      ...
      >
        <Trans>
          ChainSafe collects personal information that you give to us when you:
        </Trans>
      </Typography>
      <ul className={clsx(classes.unorderedList, classes.padLarge)}>
        <li>
          Use our Websites to sign up for services, download any file, software,
          media or other from our services.
        </li>
        <li>
          Communicate with us through email, chat, or social media, or by phone
          or any other means.
        </li>
      ...
      >
        <Trans>
          ...
          and do not guarantee that unauthorized persons will not view your User
          Contributions.
        </Trans>
      </Typography>
      ...
      >
        <Trans>
          While we do not collect cookies, third parties that are implicated or
          connected in the process of delivery and use of our Website or
          services may.
        </Trans>
      </Typography>
      <Typography
      ...
      <ul className={clsx(classes.unorderedList, classes.padLarge)}>
        ...
        <li>
          To fulfill the purposes that you provided the information for, or any
          other purpose that you provide it.
        </li>
        <li>
        ...
        <li>
          To notify you about changes to our website or any services we provide
          though it.
        </li>
        <li>
      ...
      >
        <Trans>
          Sometimes, we may disclose aggregated information about our users, and
      ...
      <ul className={clsx(classes.unorderedList, classes.padLarge)}>
        <li>
          <b>Trusted third party service providers.</b> We use third parties to
          assist us in administering and providing our services or to provide
          other services on our behalf. Examples include analyzing data,
          integrations of third party services, processing credit card payments.{" "}
        </li>
        <li>
          ...
          <ul className={clsx(classes.subUnorderedList, classes.padLarge)}>
            <li>
              ...
              Canada, compelling us to disclose personal information and account
              data for a specific user account. The records we disclose may
              include data in an unencrypted format. Because such orders
              generally state that we are not permitted to disclose the
              existence of the order to a user, we will not disclose to any user
              the existence, or nonexistence, of any order we may have received.
            </li>
            <li>
              Where there are exigent circumstances, such as where the safety or
              well-being of an individual or individuals is in imminent danger,
              and we believe in good faith that the disclosure of personal
              information and account data is reasonably necessary to protect
              against such harm, we will disclose the records. This may include
              but is not limited to the welfare of a child, or an act of
              terrorism.
            </li>
            <li>
              ...
              aware of a user that is using our services for the transmission or
              storage of Internet child pornography, we are required to report
              this to the appropriate authorities and preserve the records in
              the user’s account.
            </li>
          </ul>
        </li>
        <li>
          ...
          order to establish or exercise our legal rights, or to defend against
          legal claims, or when we believe it is necessary to share information
          in order to investigate, prevent, or take action regarding illegal
          activities, data breaches, suspected fraud, situations involving
        ...
        <li>
          ...
          transaction such as a merger, acquisition or asset sale, your personal
          information may be disclosed or transferred to the third-party
      ...
      <ol className={clsx(classes.orderedList, classes.padLarge)}>
        ...
        <li>
          Choice of service: Sign in using crypto account instead of third party
          OAuth account
        </li>
        <li>
      ...
      >
        <Trans>
          All uploaded files are stored and retrieved via end-to-end encryption
          with AES-256 and HMAC encryption.
        </Trans>
      </Typography>
      <Typography
        component="p"
      ...
      >
        <Trans>
          ...
          of age. No one under age 13 may provide any personal information on
          ...
          information on this Website or any of its features, make any purchases
          through the Website, use any of the interactive or public comment
          features of this Website, or provide any information about yourself to
          us. If we learn we have collected or received personal information
          from a child under 13, we will delete that information. If you believe
      ...
      >
        <Trans>
          ...
          exceptions set out in applicable privacy legislation. Examples of such
          exceptions include:
        </Trans>
      </Typography>
      <ul className={clsx(classes.unorderedList, classes.padLarge)}>
      ...
      >
        <Trans>
          ...
          provide you with a particular product or service.
        </Trans>
      </Typography>
      ...
      >
        <Trans>
          ...
          the Website home page.It is our policy to post any changes we make to
          our privacy policy on this page, with a notice that the privacy policy
          has been updated on the Website home page. If we make material changes
          to how we treat our users' personal information, we will notify you
