...
export const authenticationPage = {
  ...
  privacyPolicyButton: () => cy.get("[data-cy=link-privacy-policy]"),
  termsAndConditionsButton: () => cy.get("[data-cy=link-terms-and-conditions]"),
  learnMoreAboutChainsafeButton: () => cy.get("[data-cy=link-learn-more-about-chainsafe]"),
