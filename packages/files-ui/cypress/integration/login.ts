...
describe("Login with saving browser", () => {
  it("allows reload without login in again", () => {
    ...
    cy.web3Login({ saveBrowser: true, useSessionStorage: true, useLocalStorage: true })
  ...
  it("allows reload without login in again", () => {
    ...
    cy.web3Login({ saveBrowser: true, useSessionStorage: true, useLocalStorage: false })
    // cy.web3Login({ saveBrowser: false, useSessionStorage: true, useLocalStorage: false })
