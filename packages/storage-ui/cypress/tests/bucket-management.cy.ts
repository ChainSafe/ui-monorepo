...
describe("Bucket management", () => {
  ...
  context("desktop", () => {
    ...
    it.skip("can create, upload file and delete an ipfs bucket", () => {
    ...
    it.skip("can rename a file inside the ipfs bucket", () => {
      const ipfsBucketName = `ipfs bucket ${Date.now()}`
    ...
    it.skip("can download a file from ipfs bucket", () => {
      const ipfsBucketName = `ipfs bucket ${Date.now()}`
      const fileName = "text-file.txt"
      const downloadsFolder = Cypress.config("downloadsFolder")
      const fileFixturePath = `uploadedFiles/${fileName}`
    ...
    it.skip("can copy to clipboard the cid inside the ipfs bucket", () => {
      const ipfsBucketName = `ipfs bucket ${Date.now()}`
    ...
    it.skip("can delete a file inside the ipfs bucket", () => {
      const ipfsBucketName = `ipfs bucket ${Date.now()}`
    ...
    it.skip("can delete a folder inside the ipfs bucket", () => {
      const ipfsBucketName = `ipfs bucket ${Date.now()}`
      const folderName = `folder ${Date.now()}`
